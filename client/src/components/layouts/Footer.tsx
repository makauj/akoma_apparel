        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <h4 className="text-lg font-bold bg-gradient-to-r from-amber-400 to-orange-500 bg-clip-text text-transparent">
                  AKOMA Apparel
                </h4>
              </div>
            </div>
            <p className="text-gray-400 leading-relaxed">
              Bringing you authentic African fashion with a modern twist. Quality, style, and cultural heritage in every piece.
            </p>
            <div className="flex space-x-3">
              <a href="#" className="w-8 h-8 bg-gray-700 hover:bg-amber-500 rounded-full flex items-center justify-center transition-colors duration-200">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors duration-200 flex items-center text-sm">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Subscribe for the latest updates, new arrivals, and exclusive offers.
            </p>
            <div className="space-y-4">
              <div className="flex">
                <input 
                  ...
                  className="flex-1 px-4 py-2 bg-gray-700 border border-gray-600 rounded-l-lg focus:outline-none focus:ring-2 focus:ring-amber-500 text-white placeholder-gray-400"
                />
                <button className="bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 px-4 py-2 rounded-r-lg transition-all duration-200">
        ...
        <div className="border-t border-gray-700 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-400 text-sm">
              &copy; {new Date().getFullYear()} AKOMA Apparel. All rights reserved. Made with ❤️ in Kenya.
            </p>
