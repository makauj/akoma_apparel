...
const data = {
  categories: [
    {
      thumb_src: 'images/category-1.jpg',
      title: 'Women\'s Fashion',
      collection: 'Spring Collection'
    },
    {
      thumb_src: 'images/category-2.jpg',
      title: 'Men\'s Apparel',
      collection: 'Summer Collection'
    },
    {
      thumb_src: 'images/category-3.jpg',
      title: 'Accessories',
      ...
      <div className="container py-2">
        <nav aria-label="breadcrumb">
          <div className="d-flex align-items-center">
            <span className="px-3 text-lg text-white font-weight-bold me-4">Akoma Apparel</span>
          </div>
        </nav>
      ...
      <div className="container pt-3 pb-3">
          ...
          <li className="nav-item dropdown px-3 py-3 border-radius-sm bg-slate-800 d-flex align-items-center">
            ...
            <ul className="dropdown-menu dropdown-xl" aria-labelledby="dropdownProfile" data-bs-popper="static">
              <div className="row m-3">
                {data.categories.slice(0, 2).map((category: Category, index: number) => 
        ...
        <div className="p-0 ms-md-auto d-flex align-items-center">
          <div className="input-group border-dark">
            ...
            <input type="text" className="form-control max-width-200 border-dark bg-dark" placeholder="Search" onFocus={() => {}} onBlur={() => {}} />
          </div>
        </div>
      </div>
    </nav>
