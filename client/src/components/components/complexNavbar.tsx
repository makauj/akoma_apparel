      ...
      <div className="container py-2">
        <nav aria-label="breadcrumb">
          <div className="d-flex align-items-center">
            <span className="text-dark px-3 text-lg font-weight-bold me-4">Akoma Apparel</span>
          </div>
        </nav>
      ...
      <div className="container pt-3 pb-3">
          ...
          <li className="nav-item dropdown px-3 py-3 border-radius-sm d-flex align-items-center">
            ...
            <ul className="dropdown-menu dropdown-xxl" aria-labelledby="dropdownProfile" data-bs-popper="static">
              <div className="row m-3">
                {data.categories.slice(0, 3).map((category: Category, index: number) => 
        ...
        <div className="p-0 ms-md-auto d-flex align-items-center">
          <div className="input-group">
            ...
            <input type="text" className="form-control max-width-200" placeholder="Search" onFocus={() => {}} onBlur={() => {}} />
          </div>
        </div>
      </div>
    </nav>
