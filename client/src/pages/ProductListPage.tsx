...
const ProductListPage: React.FC = () => {
  ...
  const mockProducts: Product[] = [
    ...
    },
    {
      ...
      price: 35.99,
      category: "tops",
      image: "https://via.placeholder.com/300x400/FF6B35/FFFFFF?text=Dashiki+Top",
      rating: 4.7,
      reviews: 31,
    ...
    },
    {
      ...
      price: 129.99,
      category: "robes",
      image: "https://via.placeholder.com/300x400/FF6B35/FFFFFF?text=Agbada+Robe",
      rating: 4.8,
      reviews: 12,
    ...
    },
    {
      ...
      price: 55.99,
      category: "skirts",
      image: "https://via.placeholder.com/300x400/FF6B35/FFFFFF?text=Mud+Cloth+Skirt",
      rating: 4.3,
      reviews: 22,
    ...
    },
    {
      ...
      image: "https://via.placeholder.com/300x400/FF6B35/FFFFFF?text=Kente+Headwrap",
      rating: 4.6,
      reviews: 15,
  ...
  const addToCart = (product: Product) => {
    ...
    // TODO: Call your backend API to add to cart
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <h1 className="text-2xl font-bold text-orange-600">AKOMA Apparel</h1>
              <span className="ml-2 text-sm text-gray-600">Authentic African Fashion</span>
            </div>
